...
public class Scene2Guesture : MonoBehaviour
{
    ...
    //public Text text7;
    //public Text text8;
    public UnityEngine.UI.Image guangbiao;
        ...
        foreach (var itemHands in mFrame.Hands)
        {
            ...
            if (itemHands.IsLeft)
            {
                ...
                if (isGrabHand(itemHands))
                {
                   // text3.text = "左手的手势为：抓取";
                    ...
                    {
                        guangbiao.gameObject.transform.position = new Vector3(itemHands.PalmPosition.x + 0.04f, itemHands.PalmPosition.y,0);
                    }
                }
            ...
            else if (itemHands.IsRight)
            {
                ...
                if (isMoveLeft(itemHands))
                {
                    ...
                    guangbiao.gameObject.SetActive(true);
                }
                else if (isMoveRight(itemHands))
                {
